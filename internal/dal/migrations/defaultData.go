...
func Fill(db *gorm.DB) {
	users := []models.User{
		{Name: "John Doe", Email: "john@example.com", Status: "active", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "Jane Smith", Email: "jane@example.com", Status: "active", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "Michael Johnson", Email: "michael@example.com", Status: "inactive", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "Emily Davis", Email: "emily@example.com", Status: "active", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "Sarah Williams", Email: "sarah@example.com", Status: "inactive", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "David Brown", Email: "david@example.com", Status: "active", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "Linda Garcia", Email: "linda@example.com", Status: "active", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "James Martinez", Email: "james@example.com", Status: "inactive", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "Patricia Lee", Email: "patricia@example.com", Status: "active", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "Robert Wilson", Email: "robert@example.com", Status: "inactive", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "Maria Lopez", Email: "maria@example.com", Status: "active", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "William Walker", Email: "william@example.com", Status: "inactive", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "Elizabeth Moore", Email: "elizabeth@example.com", Status: "active", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "Joseph Taylor", Email: "joseph@example.com", Status: "inactive", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "Linda Anderson", Email: "linda.anderson@example.com", Status: "active", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "Charles Thomas", Email: "charles@example.com", Status: "inactive", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "Nancy Jackson", Email: "nancy@example.com", Status: "active", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "Donald Harris", Email: "donald@example.com", Status: "inactive", Photo: "", Verified: true, VerificationCode: ""},
		{Name: "Barbara Clark", Email: "barbara@example.com", Status: "active", Photo: "", Verified: true, VerificationCode: ""},
	}
